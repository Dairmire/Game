...
class Game():
    ...
    def load_images(self):
        self.bullet_surf = pygame.image.load(join('images', 'gun', 'gun.png')).convert_alpha()
    ...
    def bullet_collision(self):
        collision_sprites = pygame.sprite.spritecollide(self.gun.rect, self.enemy_sprites, False,
